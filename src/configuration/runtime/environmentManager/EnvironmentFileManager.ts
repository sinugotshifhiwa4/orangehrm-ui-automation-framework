...
import StagesFileManager from "../../environment/manager/stagesFileManager.js";
...
export default class EnvironmentFileManager {
  ...
  /**
   * Prevents direct instantiation and enforces singleton usage.
   */
  private constructor() {}
  ...
  /**
   * Loads an environment file and registers it when successful.
